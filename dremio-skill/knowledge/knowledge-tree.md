...
- **[cli/tree.md](cli/tree.md)** - **CLI Documentation**: Guide for using the Dremio CLI for administration and CI/CD.
- **[api/tree.md](api/tree.md)** - **REST API**: Reference for the Dremio REST API (Cloud & Software).
